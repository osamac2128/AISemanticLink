...
export const PIPELINE_PHASES = [
	{ key: 'queue', label: 'Queue', description: 'Building post queue' },
	{
		key: 'extract',
		label: 'Extract',
		description: 'Extracting entities from content',
	},
	{
		key: 'resolve',
		label: 'Resolve',
		description: 'Resolving entity identities',
	},
 ...
 *
 * @return {Object} Pipeline state and control functions.
 */
export function usePipeline() {
	...
	const isPhaseComplete = useCallback(
		( phaseKey ) => {
			...
			const phaseIndex = PIPELINE_PHASES.findIndex(
				( p ) => p.key === phaseKey
			);
