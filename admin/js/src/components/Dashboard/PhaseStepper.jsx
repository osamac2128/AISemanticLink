 ...
 * @return {string} Phase state: pending, active, complete, or error.
 */
 ...
 * @return {JSX.Element} PhaseStepper element.
 */
		...
		<div className={ `w-full ${ className }` }>
			<div className="relative flex items-center justify-between">
				...
				{ phases.map( ( phase, index ) => {
                  ...
                  ${
						state === 'active'
							? 'bg-phase-active text-white phase-pulse'
							: ''
					}
                  ${
						state === 'complete'
							? 'bg-phase-complete text-white'
							: ''
					}
