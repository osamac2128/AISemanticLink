 ...
 * @return {JSX.Element} PulseBar element.
 */
export default function PulseBar( {
	...
	return (
		<div className={ `w-full ${ className }` }>
			...
			<div
				className={ `relative w-full bg-slate-200 rounded-full overflow-hidden ${ barHeight }` }
			>
				{ /* Progress fill */ }
				<div
					className={ `
 ...
 * @param root0.isRunning
 * @param root0.className
 */
PulseBar.Compact = function CompactPulseBar( {
	progress,
	isRunning,
	className = '',
} ) {
