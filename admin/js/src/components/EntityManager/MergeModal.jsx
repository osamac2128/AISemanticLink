...
export default function MergeModal( {
	...
	useEffect( () => {
		if ( isOpen && entities.length > 0 ) {
			...
			const defaultMaster = entities.reduce( ( prev, curr ) =>
				( curr.mention_count || 0 ) > ( prev.mention_count || 0 )
					? curr
					: prev
			);
	...
	const mergePreview = {
		...
		entitiesToMerge: entities.filter( ( e ) => e.id !== selectedMasterId )
			.length,
	};
				...
				<div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full">
					...
					<div className="px-6 py-4 border-b border-gray-200">
						...
						<p className="mt-1 text-sm text-gray-500">
							Select which entity should be the canonical master.
							All other entities will be merged into it.
						</p>
					</div>
								...
								>
									...
									<div className="flex-1 min-w-0">
										...
										<div className="text-sm text-gray-500 mt-0.5">
											...
											mentions
											{ entity.alias_count > 0 &&
												` | ${ entity.alias_count } aliases` }
										</div>
									</div>
									{ selectedMasterId === entity.id && (
							...
							<div className="mt-4 p-4 bg-gray-50 rounded-lg">
								...
								<ul className="space-y-1 text-sm text-gray-600">
									...
									<li className="flex items-center gap-2">
										...
										{ mergePreview.aliasesToTransfer }{ ' ' }
										aliases will be transferred
									</li>
									<li className="flex items-center gap-2">
										<svg
										...
										{ mergePreview.mentionsToUpdate }{ ' ' }
										mentions will be updated
									</li>
								</ul>
							</div>
						) }
					...
					<div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
						...
						<button
							...
							disabled={
								! selectedMasterId || mergeMutation.isPending
							}
