			...
			<div className="space-y-8">
						...
						<div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
							<div className="flex items-start gap-2">
								...
								<div className="text-sm text-amber-800">
									<strong>Note:</strong> API key must be
									configured in wp-config.php as{ ' ' }
					...
					<div className="px-6 py-6 space-y-6">
						...
						<RangeSlider
							...
							displayValue={ `${ Math.round(
								formData.confidence_threshold * 100
							) }%` }
				...
				<section className="bg-white rounded-lg border border-gray-200 overflow-hidden">
					<div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
						...
						<p className="text-sm text-gray-500 mt-0.5">
							Select which post types should be processed for
							entity extraction
						</p>
					</div>
					<div className="px-6 py-6">
						...
						{ formData.post_types.length === 0 && (
							<div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
								<p className="text-sm text-amber-800">
									...
									selected. Entity extraction will not process
									any content.
								</p>
							</div>
						) }
