			...
			<div className="space-y-4">
				...
				<div>
					...
					<p className="mt-1 text-xs text-gray-500">
						This determines the Schema.org type used in JSON-LD
						output.
					</p>
				</div>
				...
				<div>
					...
					<div className="mt-2 flex items-start gap-2 p-2 bg-gray-50 rounded text-xs text-gray-600">
						...
						<div>
							<strong>raw</strong>: Newly extracted, not reviewed
							<br />
							<strong>reviewed</strong>: Human-verified accuracy
							<br />
							<strong>canonical</strong>: Official,
							production-ready
							<br />
							<strong>trash</strong>: Soft-deleted, excluded from
							Schema
						</div>
					</div>
				</div>
