		...
		<div className="p-6">
			...
			<div className="space-y-4">
				...
				<div>
					...
					<div className="flex gap-2">
						<input
							...
							onChange={ ( e ) =>
								onChange( 'same_as_url', e.target.value )
							}
				...
				<div>
					...
					{ ! wikidataIdValid && (
						<p className="mt-1 text-sm text-red-600">
							Invalid format. Wikidata IDs must start with Q
							followed by numbers (e.g., Q12345)
						</p>
					) }
